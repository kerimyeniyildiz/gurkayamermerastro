...
const PROJECTS = [
  {
    ...
    image: "https://images.unsplash.com/photo-1556912172-45b7abe8d7e1?q=80&w=800&auto=format&fit=crop",
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {PROJECTS.map((project, idx) => (
            <div key={idx} className={`group relative overflow-hidden rounded-lg cursor-pointer ${idx === 0 ? 'lg:col-span-2 lg:row-span-2 aspect-[4/3] lg:aspect-auto' : 'aspect-square'}`}>
              <img 
                src={project.image} 
                alt={project.title}
