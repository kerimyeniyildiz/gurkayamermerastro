      ...
      <div className="container mx-auto px-6 text-center md:text-left">
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-8">
          <div className="md:w-1/3">
            <div className="font-serif text-2xl text-white mb-2">GÜRKAYA</div>
            <p className="text-emerald-200/60 text-sm leading-relaxed max-w-xs mx-auto md:mx-0">
              Mermer ve granitin sanata dönüştüğü yer. İstanbul Sultangazi'de 15 yıllık tecrübe ile hizmetinizdeyiz.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-emerald-900 text-xs text-emerald-200/40 text-center">
          © {new Date().getFullYear()} Gürkaya Mermer Granit. Tüm hakları saklıdır.
        </div>
